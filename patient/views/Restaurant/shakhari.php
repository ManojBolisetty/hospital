...
<?php include_once('../header/navbar.php')?>
	...
	<center>
	<div class="size"  >
		<h3><center>Main Course</h3>

			<ul class="nav nav-pills">
  <li class="nav-item">
    <a class="nav-link" aria-current="page" href="orderfood.php" id="defaultOpen">default</a>
  </li>
  <li class="nav-item">
    <a class="nav-link  active" href="shakhari.php">Main Course</a>
  </li>
  <li class="nav-item">
...
<br><center>
<h5><b>Shakhari(vegetarian)</b></h5></center>
<?php
