...
<style>
    <?php include_once('./housekeeping.css');
    ?>
...
<form action="" method="POST" >
        <div class="container1 div_center ">
            ...
            <div class="card">
                <h5 class="card-title text-center mb-3">HouseKeeping</h5>
                <div class="row m-0">
 ...
 <div  class="mx-auto text-center"> <button type="submit" name="op" class="btn btn-primary">Request</button></div>
 </div>
</div>
</form>
</body>
